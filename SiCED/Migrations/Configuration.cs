namespace SiCED.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<SiCED.Models.ContextoEF>
    {
        ...
        protected override void Seed(SiCED.Models.ContextoEF context)
        {
            ...
            //      new Disciplina { Nome = "Barra-Chão Sênior" },
            //      new Disciplina { Nome = "Barra-Chão Iniciante" },
            //      new Disciplina { Nome = "Barra-Chão Master e Advanced" },
            //      new Disciplina { Nome = "Barra-Chão Mesclado" },
            //      new Disciplina { Nome = "Jazz Intermediário" },
            //      new Disciplina { Nome = "Jazz Lírico" },
            //      new Disciplina { Nome = "Intermediário" },
            //      new Disciplina { Nome = "Básico Iniciante" },
